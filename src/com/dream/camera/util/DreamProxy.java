...
public class DreamProxy {
    ...
    static {
        try {
            ...
            Log.e(TAG, "get class of MediaRecorder or MediaRecorderEx error:" + e.getMessage());
        }

    }

    public static Object getMediaRecoder() {
        OLD_SDK_VERSION = true;
        try {
            if (OLD_SDK_VERSION) {
            ...
            Log.e(TAG, "getMediaRecoder error:" + e.getMessage());
            return null;
        }
    }
    ...
    public static void setParam64BitFileOffset(boolean use64BitFlag) {
        ...
        try {
            ...
            Log.e(TAG, "setParam64BitFileOffset error:" + e.getMessage());
        }
    }
