...
import com.dream.camera.modules.qr.ViewfinderResultPointCallback;
...
public final class QrCaptureActivityHandler extends Handler {
    ...
    public QrCaptureActivityHandler(Activity cameraActivity,QrCodePhotoModule activity,
            Vector<BarcodeFormat> decodeFormats,
            String characterSet) {
        this.cameraActivity=cameraActivity;
        this.activity = activity;
        decodeThread = new QrDecodeThread(activity, decodeFormats, characterSet,
    ...
    public void handleMessage(Message message) {
        switch (message.what) {
            ...
            case R.id.decode_succeeded:
                if(!((CameraActivity)cameraActivity).getCameraAppUI().isModeListOpen()){
                    ...
                    Bitmap barcode = bundle == null ? null :
                            (Bitmap) bundle.getParcelable(QrDecodeThread.BARCODE_BITMAP);
            ...
            case R.id.return_scan_result:
                ...
                cameraActivity.setResult(Activity.RESULT_OK, (Intent) message.obj);
