...
public abstract class DreamUISettingPartBasic extends PreferenceCategory
    ...
    public void addListener(Context context) {
        mDataModule.addListener(context,this);
    }
    /* @ */
    ...
    private void updatePreItemsAccordingSettings(PreferenceGroup group){
...
//        mDataModule.changeSettings(preference.getKey(), newValue);
    ...
    public void releaseSource(Context context){
        if(mDataModule != null){
            mDataModule.removeListener(context,this);
        }
    }
    protected boolean isFrontCamera() {
        return mDataModule.getDataSetting().mIsFront;
    }
}
