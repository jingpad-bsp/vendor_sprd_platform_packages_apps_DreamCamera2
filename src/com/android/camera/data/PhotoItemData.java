 ...
 */
public class PhotoItemData extends FilmstripItemData {
    private String mPhotoVoice;
    private int mFileTag;

    public PhotoItemData(long contentId, String title, String mimeType, Date creationDate,
          Date lastModifiedDate, String filePath, Uri uri,
          Size dimensions, long sizeInBytes, int orientation,
          Location location, String photoVoice, int fileTag) {
        super(contentId, title, mimeType, creationDate, lastModifiedDate, filePath, uri, dimensions,
              sizeInBytes, orientation, location);
        mPhotoVoice = photoVoice;
        mFileTag = fileTag;
    }
