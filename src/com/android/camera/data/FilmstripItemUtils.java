...
public class FilmstripItemUtils {
    ...
    private static final Profiler mProfiler = Profilers.instance().guard();
    ...
    public static boolean isMimeTypeImage(String mimeType) {
        return mimeType != null && (mimeType.startsWith("image/") || mimeType.startsWith("tdImage/"));
    }
    ...
    public static Bitmap loadImageThumbnailFromStream(InputStream stream, int imageWidth,
        ...
        Profile profile = mProfiler.create("FilmstripItemUtils.loadImageThumbnailFromStream").start();
        /** 32K buffer. */
        ...
        int sampleSize = calculateSimpleSize(imageWidth, imageHeight,
                widthBound, heightBound,maximumPixels);
    ...
    private static int calculateSimpleSize(int imageWidth, int imageHeight,
        ...
        while (targetHeight > heightBound || targetWidth > widthBound ||
            ...
            targetHeight = imageHeight / sampleSize;
        }
        ...
        if ((heightBound > GL11.GL_MAX_TEXTURE_SIZE || widthBound > GL11.GL_MAX_TEXTURE_SIZE) &&
            ...
            targetHeight = imageHeight / sampleSize;
            if(targetWidth < widthBound && targetHeight < heightBound) {
                sampleSize >>= 1;
            }
        }
        return sampleSize;
    ...
    public static Bitmap loadVideoThumbnail(String path) {
        Profile profile = mProfiler.create("FilmstripItemUtils.loadVideoThumbnail").start();
        Bitmap bitmap = null;
