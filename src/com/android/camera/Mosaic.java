...
public class Mosaic {
    ...
    static {
        try {
            ...
            android.util.Log.e("Mosaic", " Load the library dream mosaic is error!!!");
        }
    }
     ...
     */
    public native void allocateMosaicMemory(int width, int height, float factorWidth, float factoreHeight);
    ...
    public native int stopCapture(boolean cancel);
}
