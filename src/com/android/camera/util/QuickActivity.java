...
public abstract class QuickActivity extends Activity {
    ...
    private static final long ON_RESUME_DELAY_SECURE_MILLIS = 15;//SPRD:fix bug935953
    ...
    protected boolean mSecurePaused = true;//SPRD:fix bug1104753
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        setDisablePreviewScreenshots(true); // SPRD: bug 723719
    }
    ...
    /**
     * Subclasses should override this in place of {@link Activity#onRestart}.
     */
