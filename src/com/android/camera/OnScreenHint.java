...
public class OnScreenHint {
    ...
    private OnScreenHint(Activity activity) {
        ...
        /* SPRD: Fix bug 542138 tips is still visible after activity has paused @{
         * original code
        ...
        if(CameraUtil.isNavigationEnable()) {
            mParams.y = activity.getWindowManager().getDefaultDisplay().getHeight() / 9 - CameraUtil.getNormalNavigationBarHeight();
        }else{
            mParams.y = activity.getWindowManager().getDefaultDisplay().getHeight() / 9;
        }
        mActivity = activity;
    }
