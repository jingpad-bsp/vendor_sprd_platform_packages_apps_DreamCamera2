...
public interface FatalErrorHandler {
    public static enum Reason {
        CANNOT_CONNECT_TO_CAMERA(R.string.camera_error_title,
                R.string.error_cannot_connect_camera,
                R.string.feedback_description_camera_access,
                true),
        CAMERA_HAL_FAILED(R.string.camera_error_title,
                R.string.error_cannot_connect_camera,
                R.string.feedback_description_camera_access,
                true),
        CAMERA_DISABLED_BY_SECURITY_POLICY(R.string.camera_error_title,
                R.string.error_camera_disabled,
                R.string.feedback_description_camera_access,
                true),
        MEDIARECORDER_START_FAILURE(R.string.camera_error_title,
                R.string.recorder_in_progress_error,
                R.string.feedback_description_camera_access,
                true),
        MEDIA_STORAGE_FAILURE(R.string.camera_error_title,
                R.string.error_media_storage_failure,
                R.string.feedback_description_save_photo,
                false),
        EXTERNAL_STORAGE_ACCESS_FAILURE(R.string.error_external_storage_access,
                R.string.feedback_description_external_access,
                R.string.feedback_description_external_access,
                false);
         ...
         */
        Reason(int dialogTitle, int dialogMsgId, int feedbackMsgId, boolean finishActivity) {
    ...
    /**
     * Handles error where the MediaRecorder is disabled due to 3rd app.
     */
    public void onMediaRecorderDisabledFailure();
    /**
     * Handles error where the external storage permission is not granted.
     */
