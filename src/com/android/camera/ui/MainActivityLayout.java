...
public class MainActivityLayout extends FrameLayout {
    ...
    // CID 109302 : UrF: Unread field (FB.URF_UNREAD_FIELD)
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        if (ev.getActionMasked() == MotionEvent.ACTION_DOWN) {
            ...
            mRequestToInterceptTouchEvents = false;
            // SPRD Bug:532618 MotionEvent is wrong.
            ...
            return false;
        /**
         * SPRD:fix bug474672 add for ucam filter scrool
        } else {
