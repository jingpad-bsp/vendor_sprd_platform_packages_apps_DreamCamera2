...
public class ModeTransitionView extends View {
    ...
    private static final int FADE_OUT_DURATION_MS = 10;
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (CameraUtil.isNavigationEnable()) {
            mHeight = bottom - CameraUtil.getNormalNavigationBarHeight() - top;
        } else {
            mHeight = bottom - top;
        }
         */
/*
        ...
        if (CameraUtil.hasCutout()) {
            mHeight -= CameraUtil.getCutoutHeight();
        }
...
*/
    ...
    public void hideModeCover(
        ...
        if (mAnimationType != IDLE) {
            ...
            alphaAnimator.addListener(new Animator.AnimatorListener() {
                @Override
                public void onAnimationStart(Animator animation) {
                    Log.i(TAG, "hideModeCover onAnimation start");
                }
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    Log.i(TAG, "hideModeCover onAnimation end");
                }
     ...
     */
    public void showImageCover(Bitmap screenShot) {
