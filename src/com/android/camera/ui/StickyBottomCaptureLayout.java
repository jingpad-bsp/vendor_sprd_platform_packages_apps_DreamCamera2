...
public class StickyBottomCaptureLayout extends FrameLayout {
    ...
    public void onFinishInflate() {
        ...
        mBottomCancel = (FrameLayout) findViewById(R.id.bottombar_cancel);
        mBottomPanel = (LinearLayout) findViewById(R.id.bottom_panel_parent);
    }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (mBottomPanel != null) {
            mBottomPanel.setPaddingRelative(mBottomPanel.getPaddingStart(), 0, mBottomPanel.getPaddingEnd(), mBottomPanel.getPaddingBottom());
        }
        if (mBottomCancel != null) {
            mBottomCancel.setPaddingRelative(mBottomCancel.getPaddingStart(), 0, mBottomCancel.getPaddingEnd(), mBottomCancel.getPaddingBottom());
        }
    }
