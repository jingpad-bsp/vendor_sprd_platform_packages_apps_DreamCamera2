 ...
 */
public class RotateImageButton extends TwoStateImageButton implements Rotatable {

    @SuppressWarnings("unused")
    private static final Log.Tag TAG = new Log.Tag("RotateImageButton");

    private static final int ANIMATION_SPEED = 300; // 270 deg/sec
    ...
    public void setTargetDegree(int degree){ mTargetDegree = degree;}
    ...
    protected boolean stateAnim = false;
